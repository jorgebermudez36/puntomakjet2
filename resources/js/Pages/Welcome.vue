            ...
            <div class="mt-3">
                <div class="grid grid-cols-1 gap-6 lg:gap-8">
                    <div clas="flex justify center">
                        <a
                            href="https://www.facebook.com/puntomak.puertosalgar"
                            class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500"
                        >
                            <div>
                                <h1
                                    class="mt-3 text-xl font-semibold text-gray-900 dark:text-white"
                                >
                                    Punto Mak
                                </h1>
                                ...
                                >
                                    Hola, bienvenido al sistema de inventario y
                                    facturacion de Punto Mak. Registrate e
                                    ingresa. Da click aqui para ingresar a
                                    nuestro Facebook.
                                </p>
                            </div>
                        </a>
